...
(function($) {
	...
	jQuery.calendars.picker.regional.af = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Vorige',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.af);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.am = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'ያለፈ',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.am);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['ar-DZ'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;السابق',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['ar-DZ']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['ar-EG'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;السابق',
		prevStatus: 'عرض الشهر السابق',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['ar-EG']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ar = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;السابق',
		prevStatus: 'عرض الشهر السابق',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ar);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.az = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Geri',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.az);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.bg = {
		renderer: jQuery.calendars.picker.defaultRenderer,
        prevText: '&#x3c;назад',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.bg);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.bs = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.bs);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ca = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Ant',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ca);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.cs = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Dříve',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.cs);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.da = {
		renderer: jQuery.calendars.picker.defaultRenderer,
        prevText: '&#x3c;Forrige',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.da);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['de-CH'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;zurück',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['de-CH']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.de = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;zurück',
		prevStatus: 'letzten Monat zeigen',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.de);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.el = {
		renderer: jQuery.calendars.picker.defaultRenderer,
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.el);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['en-AU'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Prev',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['en-AU']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['en'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Prev',
		prevStatus: 'Show the previous month',
		prevJumpText: '&lt;&lt;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['en']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['en-GB'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Prev',
		prevStatus: 'Show the previous month',
		prevJumpText: '&lt;&lt;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['en-GB']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['en-NZ'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Prev',
		prevStatus: 'Show the previous month',
		prevJumpText: '&lt;&lt;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['en-NZ']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.eo = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&lt;Anta',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.eo);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['es-AR'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Ant',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['es-AR']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['es-PE'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Ant',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['es-PE']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.es = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Ant',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.es);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.et = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Eelnev',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.et);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.eu = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Aur',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.eu);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	/* jshint -W100 */
	jQuery.calendars.picker.regional.fa = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;قبلی',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.fa);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.fi = {
		renderer: jQuery.calendars.picker.defaultRenderer,
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.fi);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.fo = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Sísta',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.fo);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['fr-CH'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Préc',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['fr-CH']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.fr = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Préc',
		prevStatus: 'Voir le mois précédent',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.fr);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.gl = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Ant',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.gl);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.gu = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;પાછળ',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.gu);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.he = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;הקודם',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.he);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['hi-IN'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'पिछला',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['hi-IN']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.hr = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.hr);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.hu = {
		renderer: jQuery.calendars.picker.defaultRenderer,
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.hu);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.hy = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Նախ.',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.hy);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.id = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;mundur',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.id);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['in'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;mundur',
		prevStatus: 'Tampilkan bulan sebelumnya',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['in']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.is = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c; Fyrri',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.is);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.it = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Prec',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.it);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ja = {
		renderer: $.extend({},
			jQuery.calendars.picker.defaultRenderer,
			{month: jQuery.calendars.picker.defaultRenderer.month.replace(/monthHeader/, 'monthHeader:yyyy年 MM')}),
		prevText: '&#x3c;前',
		prevStatus: '前月を表示します',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ja);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ka = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '<უკან',
		prevStatus: 'წინა თვე',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ka);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.km = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'ថយ​ក្រោយ',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.km);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ko = {
		renderer: $.extend({},
			jQuery.calendars.picker.defaultRenderer,
			{month: jQuery.calendars.picker.defaultRenderer.month.replace(/monthHeader/, 'monthHeader:yyyy년 MM')}),
		prevText: '이전달',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ko);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.lt = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Atgal',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.lt);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.lv = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Iepr',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.lv);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['me-ME'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;',
		prevStatus: 'Prikaži prethodni mjesec',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['me-ME']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.me = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.me);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.mk = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Претх.',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.mk);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ml = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'മുന്നത്തെ',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ml);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ms = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Sebelum',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ms);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.mt = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Ta Qabel',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.mt);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['nl-BE'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '←',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['nl-BE']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.nl = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '←',
		prevStatus: 'Bekijk de vorige maand',
		prevJumpText: '«',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.nl);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.no = {
		renderer: jQuery.calendars.picker.defaultRenderer,
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.no);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.pl = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Poprzedni',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.pl);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['pt-BR'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&lt;Anterior',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['pt-BR']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.rm = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Suandant',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.rm);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ro = {
		renderer: jQuery.calendars.picker.defaultRenderer,
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ro);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ru = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Пред',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ru);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.sk = {
		renderer: jQuery.calendars.picker.defaultRenderer,
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.sk);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.sl = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&lt;Prej&#x161;nji',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.sl);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.sq = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;mbrapa',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.sq);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['sr-SR'] = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['sr-SR']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.sr = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.sr);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.sv = {
		renderer: jQuery.calendars.picker.defaultRenderer,
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.sv);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ta = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'முன்னையது',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ta);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
    jQuery.calendars.picker.regional.te = {
        renderer: jQuery.calendars.picker.defaultRenderer,
        prevText: 'మునుపటి',
    ...
    jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.te);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.th = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&laquo;&nbsp;ย้อน',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.th);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.tr = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;geri',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.tr);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.tt = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: 'Алдагы',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.tt);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.uk = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;',
		prevStatus: '',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.uk);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.ur = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;گذشتہ',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.ur);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional.vi = {
		renderer: jQuery.calendars.picker.defaultRenderer,
		prevText: '&#x3c;Trước',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional.vi);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['zh-CN'] = {
		renderer: $.extend({},
			jQuery.calendars.picker.defaultRenderer,
			{month: jQuery.calendars.picker.defaultRenderer.month.replace(/monthHeader/, 'monthHeader:MM yyyy年')}),
		prevText: '&#x3c;上月',
		prevStatus: '显示上月',
		prevJumpText: '&#x3c;&#x3c;',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['zh-CN']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['zh-HK'] = {
		renderer: $.extend({},
			jQuery.calendars.picker.defaultRenderer,
			{month: jQuery.calendars.picker.defaultRenderer.month.replace(/monthHeader/, 'monthHeader:yyyy年 MM')}),
		prevText: '&#x3c;上月',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['zh-HK']);
});})(jQuery);
...
(function($) {
	'use strict'; jQuery(document).ready(function(){
	jQuery.calendars.picker.regional['zh-TW'] = {
		renderer: $.extend({},
			jQuery.calendars.picker.defaultRenderer,
			{month: jQuery.calendars.picker.defaultRenderer.month.replace(/monthHeader/, 'monthHeader:MM yyyy年')}),
		prevText: '&#x3c;上月',
	...
	jQuery.calendars.picker.setDefaults(jQuery.calendars.picker.regional['zh-TW']);
});})(jQuery);
