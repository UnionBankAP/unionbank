...
function FingerPrint() {
	...
	this.asyncpost_deviceprint = function asyncpost_deviceprint(url) {
		...
		var fd;
		alert("The value of variable FD is "+fd);
		...
		alert("JS INVOKED BEFORE RETURN TRUE");
		return true;
	};
}
	/*
 ...
 */
function encode_deviceprint( form ) {
	var t = add_deviceprint();
	//alert("The value of t device_print -------------- >  "+t);
	//alert("ENCODED  -----------------------------------> "+urlEncode(t));
	//this.form.elements["deviceprint"].value = t;
	document.getElementById('deviceprint').value = urlEncode(t);
	return urlEncode(t);
}
...
function post_deviceprint() {
	 ...
	 */
	//alert("bbb");
	//alert("in post"+document.forms[0].AuthenticationFG.QS.value);
	document.forms[0].pm_fp.value = encode_deviceprint();
	document.getElementById('AuthenticationFG.DEVICE_PRINT').value = encode_deviceprint();
	document.getElementById('TranRequestManagerFG.DEVICE_PRINT').value = encode_deviceprint();
	//alert("in post setting in fg "+document.getElementById('AuthenticationFG.DEVICE_PRINT').value);  
	return true;
}
