...
function getDateFromFormat(val,format) {
	...
	while (i_format < format.length) {
		...
		if (token=="yyyy" || token=="yy" || token=="y") {
			...
			MONTH_NAMES = jQuery.calendars.calendars.gregorian.prototype.regional[language].monthNames.concat(
					jQuery.calendars.calendars.gregorian.prototype.regional[language].monthNamesShort);
		...
		{
		MONTH_LONG_NAMES = jQuery.calendars.calendars.gregorian.prototype.regional[language].monthNames;
		month=0;
			for (var i=0; i<MONTH_LONG_NAMES.length; i++) 
			{
				
				var month_name=MONTH_LONG_NAMES[i];
			...
			DAY_NAMES = jQuery.calendars.calendars.gregorian.prototype.regional[language].dayNames.concat(
			jQuery.calendars.calendars.gregorian.prototype.regional[language].dayNamesShort);
