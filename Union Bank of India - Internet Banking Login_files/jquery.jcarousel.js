...
(function($) {
    ...
    $.jcarousel = function(e, o) {
        ...
        if (skin !== '' && this.container.parent()[0].className.indexOf('jcarousel-skin') == -1) {
        	if(this.options.loadHidden==true){
            this.container.wrap('<div style="display:none;" class=" '+ skin + '"></div>');
            }
            else{
        ...
        if (!windowLoaded && fsClientBrowser() == 'Safari') {
    ...
    $jc.fn.extend({
        ...
        dimension: function(e, d) {
            var el = $(e);
			var dimensionHt = "";
			//when loaded hidden outer height is not calculated properly as outerheight is returned wrong.
			//read outer height as argument while invoking plugin.
			if(this.options.loadHidden==true){
			dimensionHt=this.options.heightWhenHidden;
			}
			else{
			dimensionHt=el.outerHeight(true) || $jc.intval(this.options.itemFallbackDimension);
			}
