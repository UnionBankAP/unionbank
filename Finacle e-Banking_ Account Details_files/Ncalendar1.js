...
//Modified for call id 681123
function fnform26AS(){
	window.open("https://onlineservices.tin.nsdl.com/TIN/LoginSubmit.do");
}
function fnASBATerms(){	
	var IPONAME = document.getElementById("IPONAME").value;
	document.CustomASBAManagementFG.target="_blank";
	document.CustomASBAManagementFG.action="ASBA_Terms_&_Conditions.jsp";
	document.CustomASBAManagementFG.submit();
	}
function fnform26AS(){
	...
	mapForm.target="Map";
	mapForm.method="POST";
	mapForm.action="https://services.tdscpc.gov.in/serv/view26AS.xhtml";
	var param={"data":data,"signature":signature};
