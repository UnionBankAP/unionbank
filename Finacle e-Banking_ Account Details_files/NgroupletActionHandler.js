...
addFormAttr=function(frm,frameName,action){
	...
	if((fsClientBrowser() == 'Safari') && (frameName.toUpperCase().indexOf('DOWNLOADERFRAME')!= -1) && (navigator.userAgent.match(/(iPad|iPhone|iPod)/g)) && navigator.userAgent.match(/like Mac OS X/i)){
